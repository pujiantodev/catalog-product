...
@php
    ...
    $variantClasses = match ($variant) {
        ...
        "secondary" => "bg-secondary-400 text-white hover:bg-secondary-700 focus:ring-secondary-500 active:bg-secondary-800 dark:bg-secondary-200 dark:text-secondary-800 dark:hover:bg-secondary-600 dark:hover:text-secondary-200 dark:focus:ring-offset-secondary-800 dark:active:bg-secondary-800",
